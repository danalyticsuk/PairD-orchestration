...
async def get_processed_query():
    ...
    content_flag = saved_query.get("content flag", "Content Flag not found")
    pii_dict = saved_query.get("pii dict", "PII not found")
    pii_flag = saved_query.get("pii flag", "Error")

    return {"edited_query": llm_response, "Content Flag": content_flag, "PII dict": pii_dict, "PII flag": pii_flag}